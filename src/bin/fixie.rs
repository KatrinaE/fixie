...
fn tag_name(tag: u32) -> &'static str {
    match tag {
        ...
        // Post-Trade Account fields
        1 => "Account",
        // Post-Trade Allocation fields
        70 => "AllocID",
        71 => "AllocTransType",
        72 => "RefAllocID",
        74 => "AvgPxGroupID",
        ...
        731 => "SettlPriceType",
        734 => "PriorSettlPrice",
        // Post-Trade Confirmation fields
        664 => "ConfirmID",
        665 => "ConfirmStatus",
        666 => "ConfirmTransType",
        667 => "ConfirmType",
        // Post-Trade Settlement fields
        162 => "SettlInstSource",
        163 => "SettlLocation",
        214 => "SettlInstID",
        460 => "Product",
        // Post-Trade Trade Capture fields
        568 => "TradeRequestID",
        ...
        856 => "TradeReportType",
        857 => "TradeReportTransType",
        880 => "TrdMatchID",
        881 => "SecondaryTrdMatchID",
        916 => "AgreementDate",
        917 => "AgreementID",
        _ => "Unknown",
    }
...
fn msg_type_name(msg_type: &str) -> &'static str {
    MsgType::from_fix(msg_type)
        .map(|mt| match mt {
            ...
            MsgType::AccountSummaryReport => "AccountSummaryReport",
            MsgType::AdjustedPositionReport => "AdjustedPositionReport",
            MsgType::AllocationInstruction => "AllocationInstruction",
            MsgType::AllocationInstructionAck => "AllocationInstructionAck",
            MsgType::AllocationInstructionAlert => "AllocationInstructionAlert",
            MsgType::AllocationInstructionAlertRequest => "AllocationInstructionAlertRequest",
            MsgType::AllocationInstructionAlertRequestAck => "AllocationInstructionAlertRequestAck",
            MsgType::AllocationReport => "AllocationReport",
            MsgType::AllocationReportAck => "AllocationReportAck",
            MsgType::AssignmentReport => "AssignmentReport",
            MsgType::Confirmation => "Confirmation",
            MsgType::ConfirmationAck => "ConfirmationAck",
            MsgType::ConfirmationRequest => "ConfirmationRequest",
            MsgType::ContraryIntentionReport => "ContraryIntentionReport",
            MsgType::PositionMaintenanceReport => "PositionMaintenanceReport",
            MsgType::PositionMaintenanceRequest => "PositionMaintenanceRequest",
            MsgType::PositionReport => "PositionReport",
            MsgType::PositionTransferInstruction => "PositionTransferInstruction",
            MsgType::PositionTransferInstructionAck => "PositionTransferInstructionAck",
            MsgType::PositionTransferReport => "PositionTransferReport",
            MsgType::RequestForPositions => "RequestForPositions",
            MsgType::RequestForPositionsAck => "RequestForPositionsAck",
            MsgType::SettlementInstructionRequest => "SettlementInstructionRequest",
            MsgType::SettlementInstructions => "SettlementInstructions",
            MsgType::SettlementObligationReport => "SettlementObligationReport",
            MsgType::TradeCaptureReport => "TradeCaptureReport",
            MsgType::TradeCaptureReportAck => "TradeCaptureReportAck",
            MsgType::TradeCaptureReportRequest => "TradeCaptureReportRequest",
            MsgType::TradeCaptureReportRequestAck => "TradeCaptureReportRequestAck",
            MsgType::TradeMatchReport => "TradeMatchReport",
            MsgType::TradeMatchReportAck => "TradeMatchReportAck",
        })
        .unwrap_or("Unknown")
}
