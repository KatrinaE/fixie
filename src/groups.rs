...
pub static GROUP_REGISTRY: LazyLock<HashMap<GroupKey, GroupConfig>> = LazyLock::new(|| {
    ...
    registry.insert(
        ...
        GroupConfig {
            ...
            nested_groups: vec![NestedGroupInfo {
    ...
    registry.insert(
        ...
        GroupConfig {
            ...
            delimiter_tag: 54,
            member_tags: vec![
                54, 2102, 41, 11, 526, 583, 586, 1690, 229, 75, 1, 660, 581, 589, 590, 591, 70,
                854, 38, 152, 516, 468, 469, 12, 13, 528, 529, 1724, 1725, 1726, 1091, 582, 121,
                120,
            ],
            nested_groups: vec![NestedGroupInfo {
                num_in_group_tag: 453, // Parties (NoPartyIDs)
    ...
    registry.insert(
        GroupKey {
            num_in_group_tag: 73,
            msg_type: Some("N".to_string()),
        },
        GroupConfig {
            num_in_group_tag: 73,
            delimiter_tag: 11,
            member_tags: vec![
                11, 67, 160, 55, 65, 48, 22, 167, 200, 541, 224, 225, 239, 226, 227, 228, 255, 543,
                470, 471, 472, 240, 202, 947, 206, 231, 223, 207, 106, 107, 691, 38, 152, 516, 468,
                469, 54, 40, 44, 99, 15, 376, 377, 23, 117, 59, 168, 432, 126, 427, 12, 13, 479,
                497, 528, 529, 582, 121, 120, 775, 58, 354, 355, 193, 192, 640, 77, 203, 210, 114,
                60, 1, 660, 581,
            ],
            nested_groups: vec![
                NestedGroupInfo {
    ...
    registry.insert(
        GroupKey {
            num_in_group_tag: 398,
            msg_type: Some("k".to_string()),
        },
        GroupConfig {
    ...
    registry.insert(
        GroupKey {
            num_in_group_tag: 1201,
            msg_type: Some("m".to_string()),
        },
        GroupConfig {
    ...
    registry.insert(
        GroupKey {
            num_in_group_tag: 2430,
            msg_type: Some("DJ".to_string()),
        },
        GroupConfig {
    ...
    registry.insert(
        GroupKey {
            num_in_group_tag: 1793,
            msg_type: Some("CA".to_string()),
        },
        GroupConfig {
    ...
    registry.insert(
        ...
        GroupConfig {
            ...
            member_tags: vec![
                ...
                616, 623, 624, 566, 654, 687, 690, 564, 565,
            ],
            nested_groups: vec![
                NestedGroupInfo {
    ...
    registry.insert(
        GroupKey {
            num_in_group_tag: 146,
            msg_type: Some("R".to_string()),
        },
        GroupConfig {
    ...
    registry.insert(
        GroupKey {
            num_in_group_tag: 296,
            msg_type: Some("b".to_string()),
        },
        GroupConfig {
            num_in_group_tag: 296,
            delimiter_tag: 302,
            member_tags: vec![302, 311, 312, 309, 305, 313, 542, 304, 367, 304],
            nested_groups: vec![NestedGroupInfo {
    ...
    registry.insert(
        ...
        GroupConfig {
            ...
            delimiter_tag: 299,
            member_tags: vec![
                299, 55, 65, 48, 22, 167, 200, 541, 132, 133, 134, 135, 62, 188, 190, 189, 191,
                631, 632, 633, 634, 60, 336, 625, 64, 40, 193, 192, 15,
            ],
            nested_groups: vec![],
        },
    );
    ...
    registry.insert(
        GroupKey {
            num_in_group_tag: 1498,
            msg_type: Some("CC".to_string()),
        },
        GroupConfig {
    ...
    registry.insert(
        GroupKey {
            num_in_group_tag: 268,
            msg_type: Some("W".to_string()),
        },
        GroupConfig {
    ...
    registry.insert(
        GroupKey {
            num_in_group_tag: 73,
            msg_type: Some("BM".to_string()),
        },
        GroupConfig {
            num_in_group_tag: 73,
            delimiter_tag: 11,
            member_tags: vec![11, 37, 198, 526, 66, 38, 799, 800],
            nested_groups: vec![NestedGroupInfo {
                num_in_group_tag: 539,
                parent_tag: None,
            }],
    ...
    registry.insert(
        ...
        GroupConfig {
            num_in_group_tag: 124,
            delimiter_tag: 32,
            member_tags: vec![32, 17, 527, 31, 669, 29, 1003, 1041],
            nested_groups: vec![],
        },
    );
    ...
    registry.insert(
        ...
        GroupConfig {
            num_in_group_tag: 78,
            delimiter_tag: 79,
            member_tags: vec![79, 661, 573, 366, 80, 2515, 1752, 1753, 1754, 1755, 467],
            nested_groups: vec![NestedGroupInfo {
                num_in_group_tag: 539,
                parent_tag: None,
            }],
    ...
    // SettlInstGrp (Tag 778 = NoSettlInst)
    // Used in: SettlementInstructions (T)
    // Group of settlement instructions
    registry.insert(
        GroupKey {
            num_in_group_tag: 778,
            msg_type: None,
        },
        GroupConfig {
            num_in_group_tag: 778, // NoSettlInst
            delimiter_tag: 162,    // SettlInstID
            member_tags: vec![
                162, // SettlInstID
                163, // SettlInstTransType
                165, // SettlInstSource
                214, // SettlDeliveryType
                120, // SettlCurrency
                54,  // Side
                460, // Product
                167, // SecurityType
            ...
            nested_groups: vec![
                ...
                NestedGroupInfo {
                    num_in_group_tag: 781, // SettlPartyGrp (NoSettlPartyIDs)
                    parent_tag: None,
                },
            ],
        },
    ...
    // SettlPartyGrp (Tag 781 = NoSettlPartyIDs)
    // Used in: Settlement instructions and related messages
    // Settlement party information
    registry.insert(
        GroupKey {
            num_in_group_tag: 781,
            msg_type: None,
        },
        GroupConfig {
            num_in_group_tag: 781, // NoSettlPartyIDs
            delimiter_tag: 782,    // SettlPartyID
            member_tags: vec![
                782, // SettlPartyID
            ...
            nested_groups: vec![NestedGroupInfo {
                num_in_group_tag: 785, // SettlPartySubIDsGrp (NoSettlPartySubIDs)
                parent_tag: None,
            }],
        },
    );

    // SettlPartySubIDsGrp (Tag 785 = NoSettlPartySubIDs)
    // Nested within SettlPartyGrp
    registry.insert(
        GroupKey {
            num_in_group_tag: 785,
            msg_type: None,
        },
        GroupConfig {
            num_in_group_tag: 785, // NoSettlPartySubIDs
            delimiter_tag: 786,    // SettlPartySubID
            member_tags: vec![
                786, // SettlPartySubID
                787, // SettlPartySubIDType
            ],
            nested_groups: vec![],
        },
    );
...
pub fn is_nested_group(
    ...
    if let Some(nested_groups) = get_nested_groups(parent_num_in_group_tag, msg_type) {
        nested_groups
            .iter()
            .any(|ng| ng.num_in_group_tag == child_num_in_group_tag)
    } else {
        false
    }
}
...
mod tests {
    ...
    fn test_get_nested_groups_message_specific() {
        ...
        let nested = get_nested_groups(552, Some("s"))
            .expect("SideCrossOrdModGrp should have nested groups");
        assert_eq!(nested.len(), 1);
    ...
    fn test_list_ord_grp_new_order_list() {
        ...
        let config =
            get_group_config(73, Some("E")).expect("ListOrdGrp should exist for NewOrderList");
    ...
    fn test_list_ord_grp_list_status() {
        ...
        let config =
            get_group_config(73, Some("N")).expect("ListOrdGrp should exist for ListStatus");
        assert_eq!(config.num_in_group_tag, 73);
        assert_eq!(config.delimiter_tag, 11); // ClOrdID
    }
    ...
    fn test_list_ord_grp_has_parties_nested() {
        ...
        let nested =
            get_nested_groups(73, Some("E")).expect("ListOrdGrp should have nested groups");
    ...
    fn test_order_entry_grp_mass_order() {
        ...
        let config =
            get_group_config(2430, Some("DJ")).expect("OrderEntryGrp should exist for MassOrder");
    ...
    fn test_order_entry_ack_grp_mass_order_ack() {
        ...
        let config = get_group_config(2430, Some("DK"))
            .expect("OrderEntryAckGrp should exist for MassOrderAck");
        assert_eq!(config.num_in_group_tag, 2430);
        assert_eq!(config.delimiter_tag, 11); // ClOrdID
    ...
    fn test_target_market_segment_grp() {
        ...
        let config =
            get_group_config(1793, Some("CA")).expect("TargetMarketSegmentGrp should exist");
    ...
    fn test_affected_market_segment_grp() {
        ...
        let config =
            get_group_config(1793, Some("BZ")).expect("AffectedMarketSegmentGrp should exist");
        assert_eq!(config.num_in_group_tag, 1793);
        assert_eq!(config.delimiter_tag, 1300); // MarketSegmentID
        assert!(config.member_tags.contains(&1300)); // MarketSegmentID
        assert!(config.member_tags.contains(&1301)); // MarketID
    ...
    fn test_not_affected_market_segment_grp() {
        ...
        let config =
            get_group_config(1794, Some("BZ")).expect("NotAffectedMarketSegmentGrp should exist");
    ...
    fn test_order_entry_grp_has_parties_nested() {
        ...
        let nested =
            get_nested_groups(2430, Some("DJ")).expect("OrderEntryGrp should have nested groups");
        assert!(nested.iter().any(|n| n.num_in_group_tag == 453));
    }
    ...
    fn test_leg_ord_grp_has_leg_stipulations_nested() {
        ...
        let nested =
            get_nested_groups(555, Some("AB")).expect("LegOrdGrp should have nested groups");
